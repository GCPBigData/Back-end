...
import { BrokerageComponent } from 'app/entities/brokerage/brokerage.component';
...
describe('Component Tests', () => {
    describe('Brokerage Management Component', () => {
        let comp: BrokerageComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BrokerageComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.brokerages[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
