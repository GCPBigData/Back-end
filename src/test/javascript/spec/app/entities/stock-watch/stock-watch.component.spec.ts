...
import { StockWatchComponent } from 'app/entities/stock-watch/stock-watch.component';
...
describe('Component Tests', () => {
    describe('StockWatch Management Component', () => {
        let comp: StockWatchComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(StockWatchComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.stockWatches[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
