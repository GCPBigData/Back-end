...
import { MarketSectorComponent } from 'app/entities/market-sector/market-sector.component';
...
describe('Component Tests', () => {
    describe('MarketSector Management Component', () => {
        let comp: MarketSectorComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MarketSectorComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.marketSectors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
